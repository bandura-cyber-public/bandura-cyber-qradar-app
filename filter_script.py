...
current_packet = open('/var/log/bandura/packet_received_from_ThreatBlockr.log', "r")
current_domain = open('/var/log/bandura/domain_received_from_ThreatBlockr.log', "r")
...
def filter_logs(line):
    try:
        ...
        #else:
        list_keys = [2, 0, 'action', 'direction', 'country', 'as_name', 'reason', 'tl_category', 'domain', 1,
                 'src', 'src_port', 'dst', 'dst_port']
        for i in list_keys:
